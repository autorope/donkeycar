...
class CreateCar(BaseCommand):
    def parse_args(self, args):
        ...
        parser.add_argument(
            "--overwrite", action="store_true", help="should replace existing files"
        )
...
class MakeMovieShell(BaseCommand):
    ...
    def parse_args(self, args):
        ...
        parser.add_argument(
            "--model", default=None, help="the model to use to show control outputs"
        )
...
class TubCheck(BaseCommand):
    def parse_args(self, args):
        ...
        parser.add_argument(
            "--delete_empty", action="store_true", help="delete tub dir with no records"
        )
        parsed_args = parser.parse_args(args)
        return parsed_args
...
class ConTrain(BaseCommand):
    ...
    def run(self, args):
        ...
        continuous = True
        multi_train(
            cfg, args.tub, args.model, args.transfer, args.type, continuous, args.aug
        )
