...
ROBOCARS_CTRL_STEERING_OFFSET = 0.0 # offset to output steering when in pilot mode
...
ROBOCARS_THROTTLE_LOW = ROBOCARSHAT_LOCAL_ANGLE_FIX_THROTTLE
ROBOCARS_THROTTLE_HIGH = ROBOCARSHAT_LOCAL_ANGLE_FIX_THROTTLE
...
ROBOCARS_CONFIG_PROFILE_IARACING_SPRINT = {
    ...
    'ROBOCARS_THROTTLE_LOW' : 0.24,
    'ROBOCARS_THROTTLE_HIGH' : 0.36,
    'ROBOCARSHAT_LOCAL_ANGLE_FIX_THROTTLE' : 0.18,
    'ROBOCARS_CTRL_STEERING_OFFSET' : 0.0,
    'ROBOCARS_CTRL_ADAPTATIVE_STEERING_SCALER': 0.3,
    'OBSTACLE_DETECTOR_AVOIDANCE_ENABLED' : False,
...
ROBOCARS_CONFIG_PROFILE_IARACING_SLALOM = {
    ...
    'ROBOCARS_CTRL_STEERING_OFFSET' : 0.0,
    'ROBOCARS_CTRL_ADAPTATIVE_STEERING_SCALER': 0.5,
