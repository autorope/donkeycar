...
This file is read by your car application's pathplanner.py script to change the car
performance.
...
DEFAULT_MODEL_TYPE = 'rnn'      #(linear|categorical|rnn|motion|imu|behavior|3d|localizer|latent)
