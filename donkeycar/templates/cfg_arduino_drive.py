...
CONTROLLER_TYPE='F710'               #(ps3|ps3sixad|ps3old|ps3pc|ps4|xbox|nimbus|wiiu|F710|rc3|custom)
# Which control does what is CONTROLLER_BEHAVIOR_MAP; leave it unset to use
# the default layout for your CONTROLLER_TYPE. See cfg_complete.py.
