...
MM_PER_TICK = WHEEL_RADIUS * 3.14159265359 * 2 / ENCODER_PPR * 1000           # How much travel with a single encoder tick, in mm. Roll you car a meter and divide total ticks measured by 1,000
