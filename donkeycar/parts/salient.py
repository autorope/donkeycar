...
class SalientVis:
    ...
    def init_salient(self, model):
        ...
        x = img_in
        x = Convolution2D(24, (5, 5), strides=(2, 2), activation="relu", name="conv1")(
            x
        )
        x = Convolution2D(32, (5, 5), strides=(2, 2), activation="relu", name="conv2")(
            x
        )
        x = Convolution2D(64, (5, 5), strides=(2, 2), activation="relu", name="conv3")(
            x
        )
        x = Convolution2D(64, (3, 3), strides=(2, 2), activation="relu", name="conv4")(
            x
        )
