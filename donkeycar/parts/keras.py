...
def default_categorical():
    ...
    from tensorflow.contrib.keras.python.keras.layers import Input, Flatten, Dense, Dropout
...
def default_n_linear(num_outputs):
    from tensorflow.contrib.keras.python.keras.models import Model
    from tensorflow.contrib.keras.python.keras.layers import Input, Flatten, Dense, Dropout, Lambda
    from tensorflow.contrib.keras.python.keras.layers import Cropping2D, Convolution2D
