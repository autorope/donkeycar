            ...
            while l:
                ...
                if m:
                    ...
                    if i == 0.0:
                        ...
                        self.inSteering = self.map_range(
                            i,
                            TeensyRCin.LEFT_PULSE,
                            TeensyRCin.RIGHT_PULSE,
                            TeensyRCin.LEFT_ANGLE,
                            TeensyRCin.RIGHT_ANGLE,
                        )
                    ...
                    if k == 0.0:
                        ...
                        self.inThrottle = self.map_range(
                            k,
                            TeensyRCin.MIN_PULSE,
                            TeensyRCin.MAX_PULSE,
                            TeensyRCin.MIN_THROTTLE,
                            TeensyRCin.MAX_THROTTLE,
                        )
