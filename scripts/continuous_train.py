...
Usage:
    continuous_train.py [--tub=<tub1,tub2,..tubn>] (--model=<model>) [--transfer=<model>] [--type=(linear|categorical|rnn|imu)]
...
def continuous_train(cfg, tub_names, model_name, transfer_model, model_type):
    '''
...
if __name__ == "__main__":
    ...
    continuous_train(cfg, tub, model, transfer, model_type)
